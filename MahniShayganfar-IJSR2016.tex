...
Appraisals \and Affective Motivational Collaboration Theory}
...
requires different procedures in appraisal processes. In this paper, we provide
the relevance, desirability, expectedness, and controllability appraisals of an
...
perceived emotion will be ignored by the robot and presumed as neutral emotion.}
...
\begin{figure}[tbh]
  \vspace{-1mm}
  \centering
  \includegraphics[width=0.7\textwidth]{figure/setting.JPG}
